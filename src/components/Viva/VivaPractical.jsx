...
import vivaStudentList from "../../actions/viva/vivaStudentList";
...
function VivaPractical() {
  ...
  const getStudentVivaListMarkingData = async () => {
    try {
